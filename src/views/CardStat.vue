<template>
  <v-content>
    ...
    <v-alert color="blue-grey" type="warning" dark v-if="netrunnerdb.cards && netrunnerdb.cards.length && cardStats && !netrunnerdb.cards[cardStats.card.title].legal" data-testid="warning-rotated" class="ma-2 pa-2">
